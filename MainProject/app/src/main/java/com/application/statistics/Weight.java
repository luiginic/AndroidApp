...
public class Weight {
    ...
    public void displaySelectedInfo()
    {
        ...
        specificValue.setText(value+R.string.weight_units);
    }
    ...
    public void displayWeeklyInfo()
    {
        ...
        minValue.setText(min+R.string.weight_units);
        maxValue.setText(max+R.string.weight_units);
        lastValue.setText(last+R.string.weight_units);
        avgValue.setText(avg+R.string.weight_units);
    }
