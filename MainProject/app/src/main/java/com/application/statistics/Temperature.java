...
public class Temperature {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hearthRateValue.setText(R.string.temperature)
    ...
    public void displaySelectedInfo()
    {
        ...
        specificValue.setText(value+R.string.temperature_units);
    }
    ...
    public void displayWeeklyInfo()
    {
        ...
        minValue.setText(min+R.string.temperature_units);
        maxValue.setText(max+R.string.temperature_units);
        lastValue.setText(last+R.string.temperature_units);
        avgValue.setText(avg+R.string.temperature_units);
    }
